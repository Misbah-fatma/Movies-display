        ...
        <div className="container-fluid item_details_div">
            <div className="row d-flex align-items-center">
                ...
                <div className="offset-md-1 col-md-6 infoDiv text-white mt-5">
                    ...
                    <p id="summary">
                        Summary :  {location.state.val.show.summary}
                    </p>
                    ...
                    <Link to={location.state.val.show.officialSite} target="_blank" className="button-74">
                        Watch
                    </Link>
                    <button className="button-74" onClick={book_ticket_btn_clicked} > <span > Book ticket </span></button>

            ...
            <div className="container-fluid">
                <div className="links col-4">
                    <ul className="list-unstyled d-flex flex-row justify-content-evenly mb-0">
                        <li>
                            <Link className={`navbar-brand col-1 text-white fw-semibold ${scroll ? 'scrolled' : ''}`} to="/">Misbah</Link>
                        </li>
                        <li>
                        ...
                        <li>
                        <Link className={`nav-link active text-white mt-1 ${scroll ? 'scrolled' : ''}`} aria-current="page"  to="/">Contact</Link>
                        </li>
                        <li>
                        <Link className={`nav-link active text-white mt-1 ${scroll ? 'scrolled' : ''}`} aria-current="page"  to="/">About</Link>
                        </li>
                    </ul>
                </div>
